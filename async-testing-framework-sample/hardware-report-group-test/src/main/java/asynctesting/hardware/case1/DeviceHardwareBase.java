...
public abstract class DeviceHardwareBase extends TestCaseBase {
                                              ...
                                              String endpointUrl, Map<String, String> headers, int statusCode)
    {
        ...
        String deviceToken = "ovRkrY+XTM8Ea5gzKINDUA==..pERJHaEe0lLsPBvBtOaZWUG2ZPI=";
